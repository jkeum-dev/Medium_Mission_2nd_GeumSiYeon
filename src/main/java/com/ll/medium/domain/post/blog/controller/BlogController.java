...
public class BlogController {
	...
	public String showList(
		...
		Member blogMember = memberService.findByUsername(username)
				.orElseThrow(() -> new GlobalException("404-1", "존재하지 않는 사용자입니다."));
	...
	public String showList(
		...
		Post post = postService.findById(id)
				.orElseThrow(() -> new GlobalException("404-2", "존재하지 않는 게시글입니다."));
